...
public class ChapterUtils implements AppConstants {
    ...
    public static List<ItemDto> getChapters() {
        ...
        ItemDto item2 = new ItemDto(2, CHAPTER_2TH, "Mat與Bitmap對象");
        ItemDto item3 = new ItemDto(3, CHAPTER_3TH, "像素操作");
        ItemDto item4 = new ItemDto(4, CHAPTER_4TH, "圖像操作");
        ItemDto item5 = new ItemDto(5, CHAPTER_5TH, "分析與測量");
        ItemDto item6 = new ItemDto(6, CHAPTER_6TH, "特征檢測與匹配");*/
        ItemDto item7 = new ItemDto(7, CHAPTER_7TH, "攝像頭");
        /*ItemDto item8 = new ItemDto(8, CHAPTER_8TH, "OCR識別");
        ItemDto item9 = new ItemDto(9, CHAPTER_9TH, "人臉美化");
        ItemDto item10 = new ItemDto(10, CHAPTER_10TH, "人眼即時跟蹤與渲染");*/
        /*items.add(item1);
        items.add(item2);
        items.add(item3);
        items.add(item4);
...
//            20200323 EDIT
            items.add(new ItemDto(3, CHAPTER_7TH_PGM_CAMERA_MODE, CHAPTER_7TH_PGM_CAMERA_MODE));
        }
        if (chapterNum == 8) {
