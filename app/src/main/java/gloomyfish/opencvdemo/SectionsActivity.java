...
public class SectionsActivity extends AppCompatActivity {
    ...
    private void goDemoView(String command) {
        ...
        //        拍照後進行分析撰寫功能 20200323
        else if (command.equals(AppConstants.CHAPTER_7TH_PGM_CAMERA_MODE)) {
            Intent intent = new Intent(this.getApplicationContext(), PicAnalysisActivity.class);
            startActivity(intent);
